...
function DeleteCategory() {
    ...
    return (
        <div className='modal' tabIndex='-1' aria-labelledby="deleteCategoryModal" aria-hidden="true" id="deleteCategoryModal">
            <div className='modal-dialog'>
                <div className='modal-content'>
                    ...
                    <div className='modal-footer'>
                        ...
                        <button type='button' className='btn btn-danger' data-bs-dismiss='modal' onClick={deleteCategory}>
                            Delete
                        </button>
                    </div>
                </div>
